...
def load_cifar10(num_train_images=50000,
    ...
    Args:
        ...
        channels_last: bool, the format of the data
    Returns:
    ...
    """
    num_batches = min(5, num_train_images // 10000 + 1)
    ...
    # limit the data size
    images = images[:num_train_images]
    labels = labels[:num_train_images]
