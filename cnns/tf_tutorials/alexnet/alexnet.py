...
class AlexNet(object):
    ...
    def create(self):
        ...
        norm2 = conv2  # disable the normalization layer
        ...
        self.conv5 = conv(conv4, 3, 3, 256, 1, 1, groups=2, name='conv5')
        pool5 = max_pool(self.conv5, 3, 3, 2, 2, padding='VALID',
                         name='pool5')
        ...
        size = conv_cal(self.input_size, 11, 4, 2)
        ...
        self.fc6 = fc(flattened, size * size * 256, 4096, name='fc6')
    ...
    def load_initial_weights(self, session):
        ...
        As the weights from
        http://www.cs.toronto.edu/~guerzhoy/tf_alexnet/
        come as a dict of lists (e.g. weights['conv1'] is a list)
        and not as dict of dicts (e.g. weights['conv1'] is a dict
        with keys 'weights' & 'biases') we need a special load
        function.
        """
        ...
        for op_name in weights_dict:
            ...
            if op_name not in self.SKIP_LAYER:
                ...
                with tf.variable_scope(op_name, reuse=True):
                    ...
                    # Assign weights/biases to their corresponding
                    # tf variable
...
def conv(x, filter_height, filter_width, num_filters, stride_y, stride_x, name,
    ...
    with tf.variable_scope(name) as scope:
        # Create tf variables for the weights and biases of the
        # conv layer
