...
def plot_results(results):
    ...
    plt.subplot(2, 1, 1)
    plt.title(f"{attack_name} (black-box) attack", fontsize=title_size)
    ...
    plt.xlabel(f"{attack_name} attack strength")
    ...
    file_name = dir_path + "/" + f"{attack_name}_attack_strength_confidence_norm_gradient_"
...
def compute():
    ...
    header = [
        'adv strength',
        'rate agreement lowest gradient and max confidence',
        'rate of adv (out of correctly classified)',
