...
for j, dataset in enumerate(datasets):
    ...
    plt.plot(indexing, cols[0], label=f"{dataset[labels][0]}",
             lw=line_width,
             color=colors[j],
...
plt.xticks(indexing)
plt.title('Spectrum of Hessians w.r.t. model parameters', fontsize=title_size)
...
destination = dir_path + "/" + "eigenvals_show." + format
