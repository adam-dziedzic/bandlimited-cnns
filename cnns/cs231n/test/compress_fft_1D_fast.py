from cs231n.layers import compress_fft_1D_fast
...
# for signal_length in range(10, 271, 2):
    ...
    for y_len in range(100, 101):
        returned_signal = compress_fft_1D_fast(x, y_len=y_len)
        plot_signals(x, returned_signal, title="before/after signal compression")