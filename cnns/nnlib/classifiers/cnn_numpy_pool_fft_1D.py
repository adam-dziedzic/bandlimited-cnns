...
class ThreeLayerConvNetNumpyPoolFFT1D(object):
    """
    A three-layer convolutional network with the following architecture:

    conv - relu - 2 fft pool - affine - relu - affine - softmax
    ...
    def loss(self, X, y=None):
        ...
        maxpool1_out, combined_cache = conv_relu_pool_fft_forward_numpy_1D(X, W1, b1, conv_param, pool_param)
        ...
        dx1, dw1, db1 = conv_relu_pool_fft_backward_numpy_1D(dx2, combined_cache)
