...
import numpy as np
from nnlib.utils.perf_timing import *
...
cifar10_train = dset.CIFAR10('./nnlib/datasets', train=True, download=True,
                           transform=T.ToTensor())
loader_train = DataLoader(cifar10_train, batch_size=64, sampler=ChunkSampler(NUM_TRAIN, 0))
print("cifar10_train: ", cifar10_train)

cifar10_val = dset.CIFAR10('./nnlib/datasets', train=True, download=True,
                           transform=T.ToTensor())
loader_val = DataLoader(cifar10_val, batch_size=64, sampler=ChunkSampler(NUM_VAL, NUM_TRAIN))

cifar10_test = dset.CIFAR10('./nnlib/datasets', train=False, download=True,
                          transform=T.ToTensor())
...
we're providing the following helper functions to help you train for multiple epochs and check 
