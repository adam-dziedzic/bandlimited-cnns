...
class TestPyTorchConv1d(unittest.TestCase):
    ...
    def test_FunctionForwardCompressionConvFFTPreserveEnergy50words(self):
        x = np.array([[[-0.89094, -0.86099, -0.82438, -0.78214, -0.73573,
                        ...
                        1.1713, 1.2359, 1.3092, 1.3911, 1.4809, 1.5776, 1.6787,
                        1.7819, 1.8846, 1.9842, 2.0777, 2.1627, 2.2362, 2.2969,
                        2.3436, 2.3759, 2.3942, 2.3994, 2.3927, 2.3763, 2.3521,
                        2.3222, 2.2886, 2.2524, 2.2149, 2.1772, 2.1394, 2.1018,
                        2.0641, 2.0259, 1.9878, 1.9494, 1.9106, 1.8711, 1.8305,
                        1.7886, 1.7455, 1.7008, 1.6537, 1.6036, 1.5495, 1.492,
                        1.431, 1.3664, 1.2981, 1.2262, 1.1508, 1.0736, 0.99504,
