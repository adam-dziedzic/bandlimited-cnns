...
from .noise_layer_robust import noise_Conv2d
...
class CifarResNet(nn.Module):
    ...
    def __init__(self, block, depth, num_classes):
        ...
        self.conv_1_3x3 = noise_Conv2d(3, 16, kernel_size=3, stride=1,
                                       padding=1, bias=False, noise_std=0.13)
...
def noise_resnet20_robust_013(num_classes=10):
...
def noise_resnet110(num_classes=10):
