from nnlib.classifiers.cnn_naive_1D import ThreeLayerConvNetNaive1D
...
epoch_log = "naive_max_pool_epoch_log_" + get_log_time() + ".csv"
loss_log = "naive_max_pool_loss_log_" + get_log_time() + ".csv"

model = ThreeLayerConvNetNaive1D(weight_scale=1e-2)

epoch_log = "naive_epoch_log_" + get_log_time() + ".csv"
loss_log = "naive_loss_log_" + get_log_time() + ".csv"
