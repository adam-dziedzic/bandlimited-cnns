...
_TARGET_DIR = '/local/ady/imagenet/main/'
_SOURCE_DIR = '/local/ady/imagenet/'
...
def parse_args():
    ...
    parser.add_argument('--download-dir', default=_SOURCE_DIR,
...
def main():
    ...
    if os.path.exists(target_dir):
        raise ValueError(
            'Target dir [' + target_dir + '] exists. Remove it first')
    ...
    extract_train(train_tar_fname, os.path.join(target_dir, 'train'), build_rec,
                  args.num_thread)
