...
# from nnlib.im2col_cython import col2im_cython, im2col_cython
# from nnlib.im2col_cython import col2im_6d_cython

try:
    from nnlib.im2col_cython import col2im_cython, im2col_cython
    from nnlib.im2col_cython import col2im_6d_cython
except ImportError:
    print('run the following from the nnlib directory and try again:')
    print('python setup.py build_ext --inplace')
    print('You may also need to restart your iPython kernel')

from nnlib.im2col import *
...
def conv_forward_strides(x, w, b, conv_param):
    ...
    # print("HH: ", HH)
    # print("stride: ", stride)
    out_h = max(1, (H - HH) // stride + 1)
    out_w = max(1, (W - WW) // stride + 1)
    # print("out_h: ", out_h)
...
def max_pool_forward_im2col(x, pool_param):
    ...
    # print("W: ", W)
    # print("pool width: ", pool_width)
    # print("stride: ", stride)
    # print("width for pool: ", (W - pool_width) % stride)
