...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, version=1.0, num_classes=1000, args=None):
        ...
        if version == 1.0:
            self.features = nn.Sequential(
                ...
                conv7x7(in_planes=3, out_planes=96, stride=2, args=args),
            ...
            self.features = nn.Sequential(
                ...
                conv3x3(in_planes=3, out_planes=64, stride=2, args=args),
                nn.ReLU(inplace=True),
                nn.MaxPool2d(kernel_size=3, stride=2, ceil_mode=True),
                Fire(64, 16, 64, 64),
                Fire(128, 16, 64, 64),
